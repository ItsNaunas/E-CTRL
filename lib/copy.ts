export const copy = {
  ...
  about: {
    ...
    intro: "e-ctrl was built by Fesal, a former Amazon Marketplace Consultant who has helped hundreds of UK and EU sellers optimise their listings and scale their businesses.",
    
    whatWeDo: {
      title: "What we do",
      items: [
        "Listing readiness assessment for new sellers",
        "Keyword strategy and optimisation guidance", 
        "Fulfilment method recommendations",
        "Listing compliance and optimisation advice"
      ]
    },
