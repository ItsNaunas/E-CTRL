...
const defaultTestimonials = [
  {
    text: 'The audit revealed missing keywords that boosted my sales by 40% in just 2 weeks. The expert insights were spot-on!',
  ...
  {
    text: 'Finally found a tool backed by real Amazon experience. My conversion rate improved by 35% after implementing the recommendations.',
  ...
  {
    text: 'E-CTRL&apos;s attention to Amazon&apos;s algorithm is impressive. The keyword recommendations increased our organic traffic by 78%.',
    imageSrc: 'https://i.pravatar.cc/150?img=4',
    name: 'David Kim',
    username: '@davidkim',
    role: 'Amazon Specialist',
    location: 'United Kingdom',
    result: '78% organic traffic increase',
    rating: 5
  },
  {
