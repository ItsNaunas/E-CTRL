...
export default function StickyCTA({ onCtaClick, mode = 'audit' }: StickyCTAProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-30 backdrop-blur supports-[backdrop-filter]:bg-white/5 border-b border-white/10 shadow-lg transition-all duration-300">
